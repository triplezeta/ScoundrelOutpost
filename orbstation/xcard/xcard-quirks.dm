/datum/quirk/mind_quirk/xcard_cult_convert_immune
    ...
    value = 0
    mind_trait = TRAIT_XCARD_CULT_IMMUNE

/datum/quirk/mind_quirk/xcard_rev_convert_immune
    ...
    icon = "hammer-crash"
    value = 0
    mind_trait = TRAIT_XCARD_REV_IMMUNE

/datum/quirk/mind_quirk/xcard_facehugger_immune
    ...
    value = 0
    mind_trait = TRAIT_XCARD_XENO_IMMUNE

/datum/quirk/mind_quirk/xcard_uncyborgable
    ...
    value = 0
    mind_trait = TRAIT_XCARD_BORG_IMMUNE
