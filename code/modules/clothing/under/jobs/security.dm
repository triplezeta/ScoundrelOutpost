...
/obj/item/clothing/under/rank/security
	...
	armor = list(MELEE = 0, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 0, BIO = 10, FIRE = 30, ACID = 0, WOUND = 0)
	strip_delay = 50
...
/obj/item/clothing/under/rank/security/head_of_security
	...
	icon_state = "rhos"
	inhand_icon_state = "r_suit"
	armor = list(MELEE = 0, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 0, BIO = 10, FIRE = 50, ACID = 0, WOUND = 0)
	strip_delay = 60
