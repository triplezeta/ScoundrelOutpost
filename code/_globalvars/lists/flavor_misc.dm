...
GLOBAL_LIST_INIT(color_list_ethereal, list(
	...
	"Navy Blue" = "#6666ff",
	"Sky Blue" = "#96EAFF",
	"Seafoam Green" = "#C5FFAD",
	"Old Ethereal Green" = "#6FDB2B",
	"Ethereal Green" = "#ddff99",
	"Dark Green" = "#008900",
	"Solar Yellow" = "#FFD000",
	"Aged Yellow" = "#F9E589",
	"Furnace Orange" = "#FF3700",
	"Engineer Orange" = "#FF6026",
	"Rust Red" = "#C14949",
	"Blood Red" = "#A81212",
	"Power Red" = "#FF1919",
	"Fuschia" = "#cc0066",
	"Hot Pink" = "#FF49EC",
	"Candy Pink" = "#FFAAF6",
	"Mystic Purple" = "#8E1AED",
	"Superhot White" = "#FFFFFF",
	"Darkmatter Black" = "#250070",
))
