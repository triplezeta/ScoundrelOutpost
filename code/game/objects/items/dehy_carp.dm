...
/obj/item/toy/plush/carpplushie/dehy_carp
	...
	var/mobtype = /mob/living/simple_animal/hostile/carp/tough //So admins can change what mob spawns via var fuckery
	var/swelling = FALSE
...
// scoundrel content
// slightly more durable than normal carp
/mob/living/simple_animal/hostile/carp/tough
	maxHealth = 100
	health = 100
